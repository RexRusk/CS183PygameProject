...
class MainMenu:
    ...
    def setup_background(self):
        ...
        self.background1 = pygame.transform.scale(self.background1,
                                                  (int(self.background1_rect.width), int(self.background1_rect.height)))
    ...
    def update_buttons(self, keys):
        ...
        # play button
        if pressed_array[0] \
                and x >= C.SCREEN_W / 2 - 105.9 \
                and x <= C.SCREEN_W / 2 + 105.9 \
                and y >= C.SCREEN_H / 2 - 27.5 \
                and y <= C.SCREEN_H / 2 + 27.5:
    ...
    def update(self, surface, keys):
        ...
        surface.blit(self.gui1, (
            C.SCREEN_W / 2 - self.gui1.get_rect().size[0] / 2, C.SCREEN_H / 2 - self.gui1.get_rect().size[1] / 2))
        surface.blit(self.gui2, (
            C.SCREEN_W / 2 - self.gui2.get_rect().size[0] / 2, C.SCREEN_H / 8 * 5 - self.gui2.get_rect().size[1] / 2))
